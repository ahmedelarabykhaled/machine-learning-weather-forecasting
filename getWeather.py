...
class ModelsPredict :
    ...
    def predictLoadCover (self) : 
      ...
      load_cover = load_model('modelsPerDays/modeltraingLoadCover.h5')
    ...
    def predictWind (self) :
      ...
      wind = load_model('modelsPerDays/modelwindtraing.h5')
    ...
    def WeatherResults (self) :
      ...
      return weatherResults , predicted_Tempreature_2 , predicted_Humidity_2 , predicted_LoadCover_2 , predicted_Wind_2
